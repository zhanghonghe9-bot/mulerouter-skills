"""MiniMax Music 2.0 text-to-music generation endpoint."""
...
ENDPOINT = ModelEndpoint(
    model_id="minimax/music-2.0",
    action="generation",
    provider="minimax",
    model_name="music-2.0",
    description="Generate music from style description and lyrics. Supports structure tags ([Intro], [Verse], [Chorus], [Bridge], [Outro]). Up to 5 minutes per song. $0.03/song.",
    input_types=[InputType.TEXT],
    output_type=OutputType.AUDIO,
    api_path="/vendors/minimax/v1/music-2.0/text-to-music/generation",
    result_key="audios",
    ...
    parameters=[
        ...
        ModelParameter(
            name="lyrics_prompt",
            type="string",
            description="Lyrics of the song (10-3000 characters). Use \\n to separate lines. Structure tags: [Intro], [Verse], [Chorus], [Bridge], [Outro].",
            required=True,
        ),
        ModelParameter(
            name="audio_format",
...
class Music20Generation(BaseModelEndpoint):
    """MiniMax Music 2.0 text-to-music generation endpoint."""
