"""MiniMax Speech 2.8 Turbo text-to-speech generation endpoint."""
...
ENDPOINT = ModelEndpoint(
    ...
    description="Fast and affordable text-to-speech generation. Supports pause tags, interjection tags, voice settings, 37+ languages. $60/million characters.",
    input_types=[InputType.TEXT],
    output_type=OutputType.AUDIO,
    api_path="/vendors/minimax/v1/speech-2.8-turbo/text-to-speech/generation",
    result_key="audios",
...
class Speech28TurboGeneration(BaseModelEndpoint):
    """MiniMax Speech 2.8 Turbo text-to-speech generation endpoint."""
...
def main() -> int:
    """CLI entry point."""
    return Speech28TurboGeneration().run()
